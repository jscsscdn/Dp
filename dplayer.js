var cms_player_fun = {
	...
	'dplayer_plus' : function(){
		document.write('<script src="//cdn.jsdelivr.net/gh/jscsscdn/Dp/hls.min.js"></script>');
		document.write('<script src="//cdn.jsdelivr.net/gh/jscsscdn/Dp/flv.min.js"></script>');
	},
	'dplayer_css' : function(){
		$("<link>").attr({ rel: "stylesheet",type: "text/css",href: "//cdn.jsdelivr.net/gh/jscsscdn/Dp/DPlayer.min.css"}).appendTo("head");
	...
	'play': function(){
		...
		$.getScript("//cdn.jsdelivr.net/gh/jscsscdn/Dp/DPlayer.min.js", function(){
